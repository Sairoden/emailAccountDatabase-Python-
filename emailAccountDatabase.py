...
window = Tk()
window.withdraw()
window.title('Email Database by Sairoden Gandarosa')
...
class entity_display:
    ...
    def delete(self):
        answer = tkinter.messagebox.askquestion('Delete', 'Are you sure you want to delete this?')
...
entity_label = Label(window, text='Add Email Account', font=('Courier', 18))
...
submit = Button(window, text='Insert email', command=onsubmit, font=('Courier', 16))
